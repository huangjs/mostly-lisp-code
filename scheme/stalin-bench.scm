(define clock (foreign-procedure () int "clock" "time"))
...
(define (error-sum-of-squares N)
    (let loop ( (I 1) (Sum 0))
      (if (> I N) Sum
          (loop (+ I 1) (+ Sum (let ((E (- (r-total I) (i-total I))))
				 (* E E))))) ))

(display "Error: ")
(display (error-sum-of-squares 1000))

(display (clock))


;;; End of Stalin benchmark
;;; You will find integ-c.c in Stalin distribution.
;;; Check that Stalin is 5 times faster than C for this
;;; kind of problem.
