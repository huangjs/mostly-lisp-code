(declaim (inline vec *v +v -v dot magnitude unitise ray-sphere 
				 sray-sphere intersect sintersect ray-trace)
		 (optimize (speed 3) (debug 0) (safey 0) (compilation-speed 0)))
  ...
  (let ((obj (make-sphere :center c :radius r)))
    (if (= n 1) obj
		(let ((rt (* 3d0 (/ r (sqrt 12d0)))))
		  (labels ((kid (x z) (create (1- n) (+v c (vec x rt z)) (/ r 
																	2d0))))
			(make-group :center c
						:radius (* 3d0 r)
						:children (list obj
